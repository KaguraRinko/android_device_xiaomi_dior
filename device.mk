...
PRODUCT_COPY_FILES += \
    ...
    frameworks/natiset read ahead to 1024 and set shed to "bfq"ve/data/etc/android.hardware.sensor.compass.xml:system/etc/permissions/android.hardware.compass.xml \
